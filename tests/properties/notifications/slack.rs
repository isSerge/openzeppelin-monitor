//! Property-based tests for Slack notifications.
//!
//! These tests verify the behavior of the Slack notification system using property testing,
...
proptest! {
	...
	/// - The formatted message follows the expected Slack format: "*Title*\n\ntemplate"
	#[test]
